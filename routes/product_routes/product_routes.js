...
router.put("/:product-id/images/:imageIndex",upload.single("imageUrls"),updatebyimage)
...
router.delete("/:product-id/images/:imageIndex",upload.single("images"),deletebyimage)
